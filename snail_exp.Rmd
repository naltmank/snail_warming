...
(growth_plot <- ggplot() +
  ...
  scale_x_discrete(labels = c("Control" = "Control",
                              "Coralliophila" = expression(italic("C. violacea")),
                              "Drupella" = expression(italic("D. cornus"))
                              )
                   ) +
...
# ggsave(here::here("output", "growth_survival_plot_v4.png"), growth_surv_panel, height = 18, width = 20)
...
plot(poc_wax_area$Planar.area, poc_wax_area$Surface.area, xlab = "Planar area", ylab = "Wax dipped surface area")
